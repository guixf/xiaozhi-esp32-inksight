...
#define TAG "esp32s3_r8n16_uc8176_42"
...
class Esp32s3r8n16Uc817642 : public WifiBoard {
private:
    ...
    static void BatteryTimerCallback(void* arg) {
        Esp32s3r8n16Uc817642* board = static_cast<Esp32s3r8n16Uc817642*>(arg);
    ...
    void InitializeDisplay() {
        ...
        display_ = new Uc8176Display(EXAMPLE_LCD_WIDTH, EXAMPLE_LCD_HEIGHT, epd_spi_data);
...
public:
    Esp32s3r8n16Uc817642()
        ...
        ESP_LOGI(TAG, "Initializing ESP32S3-R8N16-UC8176-4.2 Board");
...
DECLARE_BOARD(Esp32s3r8n16Uc817642);
