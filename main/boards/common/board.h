...
public:
    ...
    virtual bool IsWakeFromDeepSleep() { return false; }
    virtual bool IsWakeByTimer() { return false; }  // 检查是否是定时器唤醒
    virtual bool CheckAndClearWakeupStartChat() { return false; }  // 检查并清除唤醒后是否需要启动对话
